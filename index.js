...
//This Function acts as the test to see which line in the Object contains the first "W"
  function superBowlWinTest(score){
   return score.result === "W" 
  }


//The main function here takes the result from the superBowlWinTest function to spit out the year the Win was obtained.
//the returned result will give undefined if there are no wins.
//recordFinal.find(superBowlWinTest) will look for the first result line that has a W and make a new Object finalResult
//the ternery statement on the return will check and see if the result is a W or not and return the year if it is

  function superbowlWin(recordFinal){
    const finalResult = recordFinal.find(superBowlWinTest)
    // if (finalResult.result === "W"){
